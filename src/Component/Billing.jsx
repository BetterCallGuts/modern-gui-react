  ...
  return (
      ...
      <section id="product" className={`${layout.sectionReverse} `}>
        ...
        <div className={`${layout.sectionImgReverse}`}>
          ...
          <div className="absolute z-[3] top-0 w-[50%] h-[50%] rounded-full -left-1/2 white__gradient "></div>
          <div className="absolute z-[0] bottom-0 w-[50%] h-[50%] rounded-full -left-1/2 pink__gradient "></div>
